...
class Panel_RE_Lag(BasePanel_RE_Lag):
    ...
    def __init__(
        ...
        set_warn(self, "This function is deprecated and was superseded by spreg.ML_LagRE in panel.py")
        n_rows = USER.check_arrays(y, x)
        bigy, bigx, name_y, name_x, T, warn = check_panel(y, x, w, name_y, name_x)
        set_warn(self, warn)
...
class Panel_RE_Error(BasePanel_RE_Error):
    ...
    def __init__(
        ...
        set_warn(self, "This function is deprecated and was superseded by spreg.ML_ErrorRE in panel.py")
        n_rows = USER.check_arrays(y, x)
        bigy, bigx, name_y, name_x, T, warn = check_panel(y, x, w, name_y, name_x)
        set_warn(self, warn)
        bigx, name_x, warn = USER.check_constant(bigx, name_x)
