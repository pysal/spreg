...
import numpy as np
import libpysal
from spreg.twosls import TSLS, BaseTSLS
...
class TestBaseTSLS(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        hthi = np.array(
            [
                [0.1597275, -0.00762011, -0.01044191],
        ...
        pfora1a2 = np.array(
            [
                [9.58156106, -0.22744226, -0.13820537],
        ...
        predy_5 = np.array(
            [[-28.68949467], [28.99484984], [55.07344824], [38.26609504], [57.57145851]]
        )
        ...
        varb = np.array(
            [
                [0.41526237, 0.01879906, -0.01730372],
        ...
        z_0 = np.array([1.0, 19.531, 80.467003])
        np.testing.assert_allclose(reg.z.toarray()[0], z_0, RTOL)
        zthhthi = np.array(
            [
                [1.00000000e00, -1.66533454e-16, 4.44089210e-16],
                [0.00000000e00, 1.00000000e00, 0.00000000e00],
                [1.26978671e01, 1.05598709e00, 3.70212359e00],
            ]
        )
    ...
    def test_n_k(self):
        ...
        vm = np.array(
            [
                [243.99486949, 11.04572682, -10.16711028],
    ...
    def test_white(self):
        ...
        vm = np.array(
            [
                [208.27139316, 15.6687805, -11.53686154],
    ...
    def test_hac(self):
        ...
        vm = np.array(
            [
                [231.07254978, 15.42050291, -11.3941033],
...
class TestTSLS(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        z_stat = np.array(
            [
                [5.84526447e00, 5.05764078e-09],
                [3.67601567e-01, 7.13170346e-01],
                [-1.99468913e00, 4.60767956e-02],
            ]
        )
