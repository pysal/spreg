...
#
# The full version.
version = spreg.__version__ #should replace it with your spreg
release = spreg.__version__ #should replace it with your spreg
...
html_theme_options = {
    ...
    'navbar_title': "spreg", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'spreg.tex', u'spreg Documentation',
...
man_pages = [
    (master_doc, 'spreg', u'spreg Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spreg', u'spreg Documentation',
     author, 'spreg', 'The Python Spatial Econometrics Package.',
     'Miscellaneous'),
]
